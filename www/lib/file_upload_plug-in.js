...
(function ($) {
    var defaultSettings = {
        ...
        fileSuffixs: ["jpg", "png","doc","docx","jpeg","rar","zip","pdf","txt","gif",'flv','avi','wmv'],//允许上传的文件后缀名列表
        ...
        submitFilesNum: 130,//最大提交上传数（当触发submitUpload方法时，文件上传的个数）
...
UploadAssist.prototype = {
    ...
    createInputFile: function () {
        ...
        //$(input).attr("name", sessionStorage.getItem('resultData'));
        ...
        input.onchange = function () {
            ...
            var fileSuf = this.value.substring(this.value.lastIndexOf(".") + 1);//文件后缀名
...
var perviewImage = {
    ...
    createPreviewElement: function (/*关闭图片名称*/name,/*上传时的文件名*/file, /*预览时的样式*/style) {
        ...
        close.style.top = "-125px";
        close.style.right = "-45px";
